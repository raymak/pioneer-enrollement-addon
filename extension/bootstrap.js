...
XPCOMUtils.defineLazyModuleGetter(this, "RecentWindow",
  "resource://pioneer-enrollment-study/RecentWindow.jsm");
...
const RESOURCE_HOST = "pioneer-enrollment-study";
const RESOURCE_HOST_CONTENT = "pioneer-enrollment-study-content";
...
this.startup = async function(data, reason) {
  ...
  resProto.setSubstitution(RESOURCE_HOST, data.resourceURI);
  resProto.setSubstitution(RESOURCE_HOST_CONTENT,
                           Services.io.newURI("content/", null, data.resourceURI));
